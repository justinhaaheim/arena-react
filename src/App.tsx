...
function getArenaType(): ArenaType {
  // Check for client in URL query parameters
  const urlParams = new URLSearchParams(window.location.search);
  return urlParams.get('client') === 'true' ? 'client' : 'full';
}
...
function App(): JSX.Element {
  const [activeQualities, setActiveQualities] = useState<readonly string[]>([]);
  ...
  const toggleQuality = useCallback(
    (word: string): void => {
      ...
      if (activeQualities.includes(word)) {
        ...
        setActiveQualities([...activeQualities, word]);
      }
    },
    [activeQualities],
  );
      ...
      <div className="container-narrow">
        ...
        <p>
          <em>
            ...
            <a href="/?client=true">Client Arena</a>
          </em>
        </p>
